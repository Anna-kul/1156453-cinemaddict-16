...
export const replace = (newElement, oldElement) => {
  ...
  const newChild = newElement instanceof AbstractView ? newElement.elem : newElement;
  const oldChild = oldElement instanceof AbstractView ? oldElement.elem : oldElement;
